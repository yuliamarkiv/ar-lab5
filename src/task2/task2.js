...
function init() {
    ...
    const ambientLight = new THREE.AmbientLight(0xffffff, 1.5); // базове м’яке світло
    scene.add(ambientLight);
    
    const directionalLight = new THREE.DirectionalLight(0xffffff, 2.5); // як сонце
    directionalLight.position.set(3, 10, 5);
    scene.add(directionalLight);
    
    // Додаємо GLTF модель на сцену
    const modelUrl = 'https://yuliia-markiv-lab5.s3.us-east-1.amazonaws.com/scene.gltf';
